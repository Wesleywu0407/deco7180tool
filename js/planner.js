      ...
      <div class="px-6 py-5">
        <div class="surface-card p-5 mb-5">
          ...
          <form id="lesson-edit-form" class="space-y-5">
            ...
            <div class="lesson-form-actions pt-3 border-t border-gray-100">
              <p class="lesson-form-note text-[12px] text-gray-400">
                Choose students from the roster to tailor support suggestions for your review.
              </p>
              <div class="lesson-form-buttons flex items-center gap-3">
