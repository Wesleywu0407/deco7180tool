...
function AdjustmentRow({ stat }) {
  ...
  return (
    <div className="card flex flex-col gap-4 sm:flex-row sm:items-center">
      {/* Icon + name */}
      <div className="flex w-full items-center gap-3 sm:w-52 sm:flex-shrink-0">
      ...
      {/* Items · lessons */}
      <p className="w-full text-sm text-gray-500 sm:w-36 sm:flex-shrink-0">
...
export default function WeeklySummary() {
  return (
    <div>
      <TopBar title="Weekly summary" subtitle="WEEK 9 · TERM 2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#1D9E75] focus:border-transparent sm:w-44"
          />
        </div>
      ...
      <div className="px-4 py-5 space-y-5 sm:px-6 lg:px-8 lg:py-6 lg:space-y-6">
